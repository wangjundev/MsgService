package com.stv.msgservice.core.mmslib.pdu;
...
import com.stv.msgservice.core.mmslib.DownloadDrmHelper;
import com.stv.msgservice.core.mmslib.DrmConvertSession;
import com.stv.msgservice.core.mmslib.InvalidHeaderValueException;
import com.stv.msgservice.core.mmslib.MmsException;
import com.stv.msgservice.core.mmslib.MmsSmsUtils;
import com.stv.msgservice.core.mmslib.PduCache;
import com.stv.msgservice.core.mmslib.PduCacheEntry;
import com.stv.msgservice.core.sms.SqliteWrapper;
...
//                    Assert.isNull(PDU_CACHE_INSTANCE.get(uri), "Pdu exists for " + uri);
    ...
    public Uri persistPart(final PduPart part, final long msgId,
        ...
        try {
            ...
            LogUtil.e(TAG, "SqliteWrapper.insert threw: "+e.toString());
        }
    ...
    public Uri persist(final GenericPdu pdu, final Uri uri, final int subId,
        ...
        if ((msgType == PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND)
            ...
            if (!recipients.isEmpty()) {
                ...
                LogUtil.e(TAG, "PduPersister.persist No recipients; persisting PDU to thread: "
                        + threadId);
            }
            values.put(Mms.THREAD_ID, threadId);
        }
        ...
        // UI.
        if (/*OsUtil.isAtLeastJB_MR1()*/true) {
            values.put(Mms.TEXT_ONLY, textOnly ? 1 : 0);
        }

        if (/*OsUtil.isAtLeastL_MR1()*/true) {
