...
import com.stv.msgservice.ui.conversation.PlayVideoActivity;
...
@EnableContextMenu
public class SingleCardStdMessageContentViewHolder extends MediaMessageContentViewHolder {
...
//    TextView refTextView;
    ...
    public SingleCardStdMessageContentViewHolder(ConversationFragment fragment, RecyclerView.Adapter adapter, View itemView) {
                ...
                if("image/png".equals(cardcontent.getMedia().getThumbnailContentType())
                    ...
                    if("video/mp4".equals(cardcontent.getMedia().getMediaContentType())){
                        ...
                        playImageView.setOnClickListener(new View.OnClickListener(){
                            @Override
                            public void onClick(View v) {
                                PlayVideoActivity.start(mFragment.getContext(), cardcontent.getMedia().getMediaUrl(), null, null);
//                                ChatbotVideoNewsDetailsActivity.start(getContext(), cardcontent.getMedia().getMediaUrl(), null, null);
                            }
                        });
                    }else if("image/jpg".equals(cardcontent.getMedia().getMediaContentType())
