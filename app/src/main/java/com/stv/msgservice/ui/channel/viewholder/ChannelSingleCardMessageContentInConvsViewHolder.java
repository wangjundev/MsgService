...
public class ChannelSingleCardMessageContentInConvsViewHolder extends ChannelMsgItemInConvsViewHolder {
    TextView getChannelSingleCardTitle;
    ...
    String chatbotPortrait;
    String chatbotName;
    int chatbotIsAttentioned;

    public ChannelSingleCardMessageContentInConvsViewHolder(Fragment fragment, RecyclerView.Adapter adapter, View itemView, View viewStubInflator,
                                                            Message messageEntity, String chatbotPortrait, String chatbotName, int chatbotIsAttentioned) {
        super(fragment, adapter, itemView);
        mFragment = fragment;
        getChannelSingleCardTitle = viewStubInflator.findViewById(R.id.channel_singlecard_title);
    ...
    private void setSuggestionsView(Context context, CardContent cardcontent){
        ...
        adpter.setSuggestions(mFragment, saw, chatbotPortrait, chatbotName, messageEntity.getSenderAddress(), chatbotIsAttentioned);
    ...
    public void onBind(Message message) {
        ...
        if(gcc != null){
            ...
            if(cardcontent != null){
                ...
                getChannelSingleCardTitle.setText(cardcontent.getTitle());

                RequestOptions options = new RequestOptions().error(R.mipmap.default_image).bitmapTransform(new RoundedCornerCenterCrop(12));//图片圆角为8
