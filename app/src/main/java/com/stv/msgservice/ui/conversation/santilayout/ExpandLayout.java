package com.stv.msgservice.ui.conversation.santilayout;
...
public class ExpandLayout extends LinearLayout {
    ...
    public void setHeight(boolean isExpand ,int viewHeight, int collapseHeight){
    ...
    private void setViewDimensions(final int expandHeight) {
        ...
        layoutView.post(new Runnable() {
            ...
            public void run() {
                ...
                LogUtil.d("ExpandLayout", "获取内容布局"+viewHeight+"-----"+expandHeight+"----"+measuredHeight);
...
//        }
        clearAnim();
        if (isExpand){
            LogUtil.d("ExpandLayout","切换动画实现"+expandHeight+"-->"+(viewHeight)+"----展开");
            animation = ValueAnimator.ofFloat(expandHeight, viewHeight);
        }else {
            LogUtil.d("ExpandLayout","切换动画实现"+viewHeight+"-->"+expandHeight+"----折叠");
...
//        animation.setStartDelay(animationDuration);
        animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                LogUtil.d("ExpandLayout","onAnimationUpdate----"+"-----"+value);
