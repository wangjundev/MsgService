...
@ContentTag(type = MessageConstants.CONTENT_TYPE_SINGLE_CARD_WITH_SUGGESTION)
public class SingleCardWithSuggestionsMessageContent extends MessageContent {
    private String content;
    // 引用信息
//    private QuoteInfo quoteInfo;

    public SingleCardWithSuggestionsMessageContent() {
    }

    public SingleCardWithSuggestionsMessageContent(String content) {
...
//        dest.writeParcelable(this.quoteInfo, flags);
    ...
    protected SingleCardWithSuggestionsMessageContent(Parcel in) {
        super(in);
        this.content = in.readString();
//        this.quoteInfo = in.readParcelable(QuoteInfo.class.getClassLoader());
    }

    public static final Creator<SingleCardWithSuggestionsMessageContent> CREATOR = new Creator<SingleCardWithSuggestionsMessageContent>() {
        @Override
        public SingleCardWithSuggestionsMessageContent createFromParcel(Parcel source) {
            return new SingleCardWithSuggestionsMessageContent(source);
        }

        @Override
        public SingleCardWithSuggestionsMessageContent[] newArray(int size) {
            return new SingleCardWithSuggestionsMessageContent[size];
        }
    };
}
