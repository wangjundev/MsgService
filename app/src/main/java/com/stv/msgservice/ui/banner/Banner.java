package com.stv.msgservice.ui.banner;
...
public class Banner extends RelativeLayout {
    ...
    private void initViews(final Context context) {
        ...
        viewPager2.setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
