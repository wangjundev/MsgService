package com.stv.msgservice.ui.videoplayer.ui;
...
import com.stv.msgservice.ui.videoplayer.controller.GestureVideoController;
...
public class StandardVideoController<T extends MediaPlayerControl> extends GestureVideoController<T>
    ...
    //add by junwang
    public View getStartPlayButton(){
    ...
    public void setPlayerState(int playerState) {
        ...
        switch (playerState) {
            case DanmuVideoView.PLAYER_NORMAL:
                L.e("PLAYER_NORMAL");
                if (mIsLocked) return;
                if (mNeedAdaptCutout) {
                ...
                break;
            case DanmuVideoView.PLAYER_FULL_SCREEN:
    ...
    public void setPlayState(int playState) {
        ...
        switch (playState) {
            //调用release方法会回到此状态
            case DanmuVideoView.STATE_IDLE:
                L.e("STATE_IDLE");
                hide();
                mIsLocked = false;
                ...
                break;
            case DanmuVideoView.STATE_PLAYING:
                L.e("STATE_PLAYING");
                //开始刷新进度
                post(mShowProgress);
                ...
                break;
            case DanmuVideoView.STATE_PAUSED:
                L.e("STATE_PAUSED");
                mPlayButton.setSelected(false);
                mStartPlayButton.setVisibility(GONE);
                //removeCallbacks(mShowProgress);
                break;
            case DanmuVideoView.STATE_PREPARING:
                L.e("STATE_PREPARING");
                mCompleteContainer.setVisibility(GONE);
                mStartPlayButton.setVisibility(GONE);
                mStatusView.dismiss();
...
//                mThumb.setVisibility(VISIBLE);
                break;
            case DanmuVideoView.STATE_PREPARED:
                L.e("STATE_PREPARED");
                if (!mIsLive) mBottomProgress.setVisibility(VISIBLE);
//                mLoadingProgress.setVisibility(GONE);
                mStartPlayButton.setVisibility(GONE);
                break;
            case DanmuVideoView.STATE_ERROR:
                L.e("STATE_ERROR");
                ...
                mTopContainer.setVisibility(GONE);
                break;
            case DanmuVideoView.STATE_BUFFERING:
                L.e("STATE_BUFFERING");
                mStartPlayButton.setVisibility(GONE);
                mLoadingProgress.setVisibility(VISIBLE);
                mThumb.setVisibility(GONE);
                ...
                break;
            case DanmuVideoView.STATE_BUFFERED:
                L.e("STATE_BUFFERED");
                mLoadingProgress.setVisibility(GONE);
                mStartPlayButton.setVisibility(GONE);
                mThumb.setVisibility(GONE);
                mPlayButton.setSelected(mMediaPlayer.isPlaying());
                break;
            case DanmuVideoView.STATE_PLAYBACK_COMPLETED:
    ...
    public void onPositionChange(int slidePosition, int currentPosition, int duration) {
        ...
        if (slidePosition > currentPosition) {
            mCenterView.setIcon(R.mipmap.dkplayer_ic_action_fast_forward);
        } else {
            mCenterView.setIcon(R.mipmap.dkplayer_ic_action_fast_rewind);
        }
    ...
    public void onBrightnessChange(int percent) {
        ...
        mCenterView.setIcon(R.mipmap.dkplayer_ic_action_brightness);
    ...
    public void onVolumeChange(int percent) {
        mCenterView.setProVisibility(View.VISIBLE);
        if (percent <= 0) {
            mCenterView.setIcon(R.mipmap.dkplayer_ic_action_volume_off);
        } else {
            mCenterView.setIcon(R.mipmap.dkplayer_ic_action_volume_up);
        }
        mCenterView.setTextView(percent + "%");
        mCenterView.setProPercent(percent);
    }
