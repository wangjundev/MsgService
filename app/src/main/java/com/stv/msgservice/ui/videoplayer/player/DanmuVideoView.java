...
import com.stv.msgservice.ui.videoplayer.controller.BaseVideoController;
import com.stv.msgservice.ui.videoplayer.controller.MediaPlayerControl;
import com.stv.msgservice.ui.videoplayer.listener.OnVideoViewStateChangeListener;
import com.stv.msgservice.ui.videoplayer.listener.PlayerEventListener;
import com.stv.msgservice.ui.videoplayer.render.IRenderView;
import com.stv.msgservice.ui.videoplayer.render.SurfaceRenderView;
import com.stv.msgservice.ui.videoplayer.render.TextureRenderView;
import com.stv.msgservice.ui.videoplayer.util.L;
...
//import com.stv.msgservice.ui.videoplayer.util.LogUtil;
...
public class DanmuVideoView<P extends AbstractPlayer> extends FrameLayout implements MediaPlayerControl, PlayerEventListener {

    protected P mMediaPlayer;//播放器
    protected PlayerFactory<P> mPlayerFactory;//工厂类，用于实例化播放核心
    @Nullable
    public BaseVideoController mVideoController;//控制器
...
//    protected static final int FULLSCREEN_FLAGS= View.SYSTEM_UI_FLAG_LAYOUT_STABLE
...
//            | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
    ...
    public DanmuVideoView(@NonNull Context context) {
        this(context, null);
    }

    public DanmuVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DanmuVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        //读取全局配置
        com.stv.msgservice.ui.videoplayer.player.VideoViewConfig config = com.stv.msgservice.ui.videoplayer.player.VideoViewManager.getConfig();
    ...
    public void setVideoCover(Bitmap cover){
        mPlayerContainer.setBackground(new BitmapDrawable(getResources(), cover));
    }
     ...
     */
    public void release() {
        LogUtil.i("junwang", "SantiVideoView release");
