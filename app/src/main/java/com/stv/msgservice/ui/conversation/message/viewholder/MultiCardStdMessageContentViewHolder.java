...
@EnableContextMenu
public class MultiCardStdMessageContentViewHolder  extends MediaMessageContentViewHolder {
...
//    LinearLayout cardLayout;
    ...
    public MultiCardStdMessageContentViewHolder(ConversationFragment fragment, RecyclerView.Adapter adapter, View itemView) {
