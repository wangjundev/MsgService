package com.stv.msgservice.ui.videoplayer.controller;
...
public abstract class BaseVideoController<T extends MediaPlayerControl> extends FrameLayout
        implements com.stv.msgservice.ui.videoplayer.controller.OrientationHelper.OnOrientationChangeListener {
    ...
    protected com.stv.msgservice.ui.videoplayer.controller.OrientationHelper mOrientationHelper;
    ...
    protected void initView() {
        ...
        setClickable(true);
        setFocusable(true);
        mOrientationHelper = new com.stv.msgservice.ui.videoplayer.controller.OrientationHelper(getContext().getApplicationContext());
    ...
    public void setPlayState(int playState) {
        ...
        if (playState == DanmuVideoView.STATE_IDLE) {
    ...
    public void setPlayerState(int playerState) {
        ...
        switch (playerState) {
            ...
            case DanmuVideoView.PLAYER_FULL_SCREEN:
                ...
                mOrientationHelper.enable();
                break;
            case DanmuVideoView.PLAYER_TINY_SCREEN:
                mOrientationHelper.disable();
                break;
        }
    }
    ...
    protected void doPauseResume() {
        if (mCurrentPlayState == DanmuVideoView.STATE_BUFFERING) return;
